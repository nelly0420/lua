...
local function ontreeRelease()
    composer.showOverlay('onmossyRelease')
...
function scene:create(event)
    ...
    local speaker = display.newText( "아라", display.contentWidth * 0.45, display.contentHeight * 0.85, display.contentWidth - 180, 150)
    speaker:setFillColor(0, 0, 0)
    speaker.size = 43
    speaker.alignX = "left"


    local content = display.newText( "이끼를 맞는 건 기분 나쁜 일이야...", display.contentWidth * 0.45, display.contentHeight * 0.87, display.actualContentWidth - 180, -120)
