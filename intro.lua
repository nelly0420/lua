...
local function onnxtBtnRelease()
...
function scene:create( event )
	...
	local background = display.newImageRect( "ui/null.png", display.actualContentWidth, display.actualContentHeight )
	...
	local eff = audio.loadStream( "effect/laugh.wav" )
	audio.play(eff)
	...
	nxtBtn = widget.newButton{
		label = "▶",
		labelColor = { default={ 1.0 }, over={ 1.0 } },
		defaultFile = "ui/btn_nil.png",
		overFile = "ui/btn_nil.png",
		width = 154, height = 60,
		onRelease = onnxtBtnRelease	-- event listener function
	}
	nxtBtn.x = display.contentCenterX + 550
	nxtBtn.y = display.contentHeight -50

	-- all display objects must be inserted into group
	sceneGroup:insert( background )
	sceneGroup:insert( backBtn )
	sceneGroup:insert( skipBtn )
	sceneGroup:insert( nxtBtn )
